...
* Download the latest [QualityAssessmentTools-0.5.1.jar](https://github.com/SoftwareExtensionRenovators/QualityAssessmentTools/blob/FifthDelivery/QualityAssessmentTools-0.5.1.jar)
